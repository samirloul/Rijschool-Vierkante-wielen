...
INSERT INTO Rijbewijscategorie (Naam, Omschrijving) VALUES
...
INSERT INTO Gebruiker (Voornaam, Tussenvoegsel, Achternaam, Email, WachtwoordHash, Telefoonnummer, Geboortedatum, Rol, AdresId) VALUES
     ('Pieter',  NULL,    'Janssen',    'admin@vierkantewielen.nl',      '$2b$12$adminHashVoorbeeld000000000000000000000000000000000000', '06-10000001', '1975-03-15', 'Administrator', 1)
    ,('Lars',    NULL,    'de Vries',   'lars.devries@vierkantewielen.nl','$2b$12$instrHashVoorbeeld000000000000000000000000000000000001', '06-10000002', '1985-06-20', 'Instructeur',   2)
    ,('Sanne',   NULL,    'Bakker',     'sanne.bakker@vierkantewielen.nl','$2b$12$instrHashVoorbeeld000000000000000000000000000000000002', '06-10000003', '1990-09-11', 'Instructeur',   3)
    ,('Kevin',   'van',   'den Berg',   'kevin.vdberg@vierkantewielen.nl','$2b$12$instrHashVoorbeeld000000000000000000000000000000000003', '06-10000004', '1988-12-01', 'Instructeur',   4)
    ,('Fatima',  NULL,    'El Amrani',  'fatima.elamrani@vierkantewielen.nl','$2b$12$instrHashVoorbeeld000000000000000000000000000000000004','06-10000005','1992-04-22','Instructeur', 5)
    ,('Tim',     NULL,    'Willems',    'tim.willems@student.nl',         '$2b$12$leerHashVoorbeeld000000000000000000000000000000000005', '06-20000001', '2005-01-10', 'Leerling',      6)
    ,('Emma',    NULL,    'Smit',       'emma.smit@student.nl',           '$2b$12$leerHashVoorbeeld000000000000000000000000000000000006', '06-20000002', '2006-07-18', 'Leerling',      7)
    ,('Daan',    'van',   'der Laan',   'daan.vdlaan@student.nl',         '$2b$12$leerHashVoorbeeld000000000000000000000000000000000007', '06-20000003', '2005-11-03', 'Leerling',      8)
    ,('Sophie',  NULL,    'Peters',     'sophie.peters@student.nl',       '$2b$12$leerHashVoorbeeld000000000000000000000000000000000008', '06-20000004', '2007-02-14', 'Leerling',      9)
    ,('Noah',    NULL,    'Mulder',     'noah.mulder@student.nl',         '$2b$12$leerHashVoorbeeld000000000000000000000000000000000009', '06-20000005', '2006-09-30', 'Leerling',      10);
...
INSERT INTO Instructeur (GebruikerId, Rijbewijsnummer, IndienstDatum) VALUES
...
INSERT INTO Leerling (GebruikerId, RijbewijscategorieId, HeeftBeperking, OmschrijvingBeperking) VALUES
     (6,  1, 1, 'Beperkte mobiliteit rechterhand, handauto vereist')
    ,(7,  1, 1, 'Visuele beperking (gecorrigeerd), extra lestijd nodig')
    ,(8,  1, 0, NULL)
    ,(9,  1, 1, 'Gehoorbeperking, visuele signalering gewenst')
    ,(10, 1, 0, NULL);
...
INSERT INTO Voertuig (Merk, Type, Kenteken, Bouwjaar, IsElektrisch) VALUES
...
INSERT INTO Lespakket (Naam, AantalLessen, Prijs, Omschrijving) VALUES
     ('Kennismakingspakket',  5,  225.00, '5 lessen voor beginners')
    ,('Standaardpakket',     10,  420.00, '10 lessen inclusief theorie-begeleiding')
    ,('Intensiefpakket',     20,  780.00, '20 lessen, snel rijbewijs halen')
    ,('Maatwerkpakket',       1,   49.50, 'Losse les, flexibel bij te kopen');
...
INSERT INTO LespakketPerLeerling (LeerlingId, LespakketId, AantalLessenResterend, DatumAankoop) VALUES
     (1, 2, 8,  '2026-05-01')
    ,(2, 1, 3,  '2026-05-10')
    ,(3, 3, 18, '2026-04-20')
    ,(4, 2, 10, '2026-05-15')
...
INSERT INTO Ziekmelding (InstructeurId, DatumVanaf, DatumTem, Reden) VALUES
...
INSERT INTO Rijles (LeerlingId, InstructeurId, VoertuigId, DatumTijd, DuurMinuten, OphaaladresId, Lesdoel, TeBehandelenOnderwerp, Status) VALUES
     (1, 1, 1, '2026-06-02 09:00:00', 60, 6,  'Stadsrijden',        'Voorrang en kruispunten',     'Gepland')
    ,(2, 2, 2, '2026-06-02 10:30:00', 60, 7,  'Snelweg invoegen',   'Snel rijden en afstand houden','Gepland')
    ,(3, 3, 3, '2026-06-03 08:00:00', 60, 8,  'Parkeren',           'Inparkeren en uitparkeren',   'Gepland')
    ,(4, 1, 1, '2026-06-03 11:00:00', 60, 9,  'Gevaarherkenning',   'Kwetsbare verkeersdeelnemers','Gepland')
    ,(5, 4, 2, '2026-06-04 14:00:00', 60, 10, 'Intro rijles',       'Basis rijvaardigheid',        'Gepland')
    ,(1, 1, 1, '2026-05-26 09:00:00', 60, 6,  'Basisrijvaardigheid','Optrekken en remmen',         'Gegeven')
    ,(2, 2, 2, '2026-05-27 10:30:00', 60, 7,  'Rotondes',           'Verkeersregels rotonde',      'Gegeven');
...
INSERT INTO Examen (LeerlingId, InstructeurId, Soort, DatumTijd, Locatie, Status, Resultaat) VALUES
     (1, 1, 'Theorie', '2026-06-10 10:00:00', 'CBR Tilburg', 'Aangevraagd', NULL)
    ,(3, 3, 'Praktijk','2026-06-20 13:00:00', 'CBR Tilburg', 'Aangevraagd', NULL);
...
INSERT INTO Opmerking (RijlesId, GebruikerId, Tekst) VALUES
     (6, 2, 'Tim optrok soepel; remmen nog iets eerder anticiperen.')
    ,(6, 6, 'Ik vond het een goede les, voelde me zeker!')
    ,(7, 3, 'Emma beheerst rotondes goed. Volgende les snelweg.')
    ,(7, 7, 'Spannend maar ik deed het goed, blij met de feedback.');
...
INSERT INTO Melding (AfzenderId, Titel, Inhoud, Doelrol) VALUES
     (1, 'Welkom bij Vierkante Wielen!',    'Vanaf 1 juni zijn wij officieel gestart. Welkom allemaal!',                         NULL)
    ,(1, 'Nieuwe auto beschikbaar',         'De Tesla Model 3 is nu ingepland voor lessen. Spreek dit af met uw instructeur.',   'Leerling')
    ,(1, 'Vergadering instructeurs 5 juni', 'Op 5 juni om 17:00 is er een teamoverleg. Locatie: lesruimte rijschool.',            'Instructeur');
...
INSERT INTO Factuur (LeerlingId, Factuurnummer, Factuurdatum, Vervaldatum, BedragExclBTW, BTWPercentage, BedragInclBTW, Status) VALUES
     (1, 'VW-2026-0001', '2026-05-01', '2026-05-15', 347.11, 21.00, 420.00, 'Betaald')
    ,(2, 'VW-2026-0002', '2026-05-10', '2026-05-24', 185.95, 21.00, 225.00, 'Verstuurd')
    ,(3, 'VW-2026-0003', '2026-04-20', '2026-05-04', 644.63, 21.00, 780.00, 'Betaald')
    ,(4, 'VW-2026-0004', '2026-05-15', '2026-05-29', 347.11, 21.00, 420.00, 'Concept')
    ,(5, 'VW-2026-0005', '2026-05-28', '2026-06-11',  40.91, 21.00,  49.50, 'Verstuurd');
...
INSERT INTO Betaling (FactuurId, Bedrag, Betaaldatum, Betaalmethode, Referentie) VALUES
     (1, 420.00, '2026-05-14', 'Ideal',       'iDEAL-20260514-001')
    ,(3, 780.00, '2026-05-03', 'Overboeking',  'OVB-20260503-003');
